...
class Link(models.Model):
    ...
    weight = models.PositiveIntegerField(default=1, choices=zip(range(1, 6), range(1, 6)), verbose_name='权重', help_text='权重高意味着展示排序靠前')
...
class SideBar(models.Model):
    ...
    @property
    def content_html(self):  # 将数据的渲染封装到Model层，对数据进行渲染并返回
